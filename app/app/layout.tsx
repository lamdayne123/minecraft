...
export const metadata: Metadata = {
  ...
  description:
    "Máy chủ Minecraft Survival chất lượng cao. Java & Bedrock. Tham gia ngay để khám phá thế giới Craftopia!",
  ...
  openGraph: {
    ...
    description:
      "Máy chủ Minecraft Survival chất lượng cao. Java & Bedrock.",
