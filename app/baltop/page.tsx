              ...
              <section className="grid grid-cols-3 items-end gap-2 sm:gap-5">
                {sortedPlayers.slice(0, 3).map((player, index) => {
                  ...
                  return (
                    <article
                      key={name}
                      className={`relative h-full overflow-hidden rounded-[2rem] border p-2 text-center backdrop-blur-xl transition hover:-translate-y-1 sm:p-6 ${rankStyles} ${podiumOffset}`}
                    >
                      {rank === 1 && (
                      ...
                      >
                        ...
                        <div className="flex min-w-0 items-center gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="truncate text-xs text-zinc-500">Craftopia Survival</div>
                          </div>
                        </div>
