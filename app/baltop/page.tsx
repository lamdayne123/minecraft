      ...
      <style>{`
        ...
        @media (max-width: 767px) {
          .craftopia-marquee-track {
            display: inline-flex;
            width: max-content;
            animation: craftopia-marquee 8s linear infinite;
            ...
            .map(
              ...
              >
                ...
                <div className="mx-auto mb-4 flex h-28 w-28 items-center justify-center rounded-[1.65rem] border border-white/10 bg-zinc-950/80 shadow-[0_10px_24px_rgba(0,0,0,0.4)]">
                  <img
                    src={`https://mc-heads.net/head/${encodeURIComponent(getPlayerName(player))}/128`}
                    alt={getPlayerName(player)}
                    className="h-24 w-24 rounded-[1.1rem] object-cover"
                    style={{ imageRendering: "pixelated" }}
                    onError={(e) => {
                      const target = e.currentTarget as HTMLImageElement;
                      target.src = "https://mc-heads.net/head/Steve/128";
                    }}
                  />
                </div>
                  ...
                  <div className="min-w-0">
                    <div className="block max-w-[9rem] overflow-hidden whitespace-nowrap md:hidden">
                      <div className="craftopia-marquee-track">
                        <span className="pr-8 text-lime-400">{getPlayerName(player)}</span>
            ...
            .map(
              ...
              >
                ...
                >
                  ...
                  <img
                    src={`https://mc-heads.net/head/${encodeURIComponent(getPlayerName(player))}/64`}
                    alt={getPlayerName(player)}
